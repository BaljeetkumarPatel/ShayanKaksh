...
export const cities = [
  // 🇮🇳 ~65+ major Indian cities
  "Delhi", "Mumbai", "Kolkata", "Bangalore", "Chennai", "Hyderabad",
  "Ahmedabad", "Pune", "Surat", "Lucknow", "Kanpur", "Nagpur",
  "Indore", "Thane", "Bhopal", "Visakhapatnam", "Pimpri-Chinchwad",
  "Patna", "Vadodara", "Ghaziabad", "Ludhiana", "Agra", "Nashik",
  "Faridabad", "Meerut", "Rajkot", "Kalyan-Dombivli", "Vasai-Virar",
  "Varanasi", "Srinagar", "Aurangabad", "Dhanbad", "Amritsar",
  "Navi Mumbai", "Prayagraj", "Howrah", "Ranchi", "Jabalpur",
  "Gwalior", "Coimbatore", "Vijayawada", "Jodhpur", "Madurai",
  "Raipur", "Kota", "Chandigarh", "Guwahati", "Solapur", "Hubli-Dharwad",
  "Tiruchirappalli", "Bareilly", "Aligarh", "Tiruppur", "Moradabad",
  "Jalandhar", "Salem", "Mysore", "Gurgaon", "Nagpur", "Guntur",
  "Bhubaneswar", "Amravati", "Allahabad", "Nanded", "Kolhapur",
  ...
  "Corpus Christi", "Riverside", "Lexington", "St. Louis", "Stockholm",
  "Amsterdam", "Berlin", "Madrid", "Rome", "Paris", "Vienna", "Barcelona",
  "Moscow", "Istanbul", "Tokyo", "Beijing", "Shanghai", "Seoul",
  "Singapore", "Dubai", "Hong Kong", "Bangkok", "Guangzhou", "Mumbai",
  "Mexico City", "São Paulo", "Lagos", "Cairo", "Buenos Aires",
  "Cape Town", "Lima", "Santiago", "Johannesburg", "Tehran", "Baghdad",
  "Karachi", "Manila", "Jakarta", "Kuala Lumpur", "Taipei", "Delhi",
  "Surrey", "Montreal", "Vancouver", "Toronto", "Sydney", "Melbourne",
  "Brisbane", "Auckland", "Perth", "Adelaide", "Christchurch",
  "Buenos Aires", "Bogotá", "Lima", "Rio de Janeiro", "Lisbon", "Warsaw",
  "Prague", "Budapest", "Athens", "Dublin", "Copenhagen", "Helsinki",
  "Oslo", "Stockholm", "Reykjavik", "Manama", "Doha", "Muscat",
  "Riyadh", "Jeddah", "Tel Aviv", "Casablanca", "Cape Town", "Nairobi",
  "Addis Ababa", "Accra", "Abuja", "Lahore", "Karachi"
];
