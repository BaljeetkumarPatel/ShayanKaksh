...
const AllRooms=()=>{
    ...
    //functin
    //Handlechange for filter and sorting
    ...
    //function to check if a room matches the selected prices ranges
  ...
  const filteredRooms=useMemo(()=>{
    return rooms.filter(room=>
        matchesRoomType(room) && matchesPriceRange(room) && filterDestination(room)).sort(sortRooms);
